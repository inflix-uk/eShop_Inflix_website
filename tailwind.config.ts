  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        bookingCardFg: "var(--booking-card-fg, #111827)",
        bookingCardMuted: "var(--booking-card-fg-muted, #6b7280)",
        bookingCardSurface: "var(--booking-card-surface, #f3f4f6)",
        bookingCardSurfaceBorder: "var(--booking-card-surface-border, #e5e7eb)",
        bookingCardDivider: "var(--booking-card-divider, #e5e7eb)",
