...
/** Legacy hardcoded page when no published CMS footer page exists for `deals-and-discounts`. */
export default function DealsAndDiscountsFallback() {
          ...
          <div className="grid grid-cols-1 gap-6">
            {filteredOffers.length > 0 ? (
              filteredOffers.map((offer) => (
                <OfferCard key={String(offer.id ?? offer.title)} offer={offer} />
              ))
            ) : (
              <div className="text-center py-12">
