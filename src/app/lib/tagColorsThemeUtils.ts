...
const CUSTOM_COLOR_EXCLUSION =
  ":not([data-banner-text]):not([data-navbar-btn-text]):not([data-booking-btn-text]):not(.checkout-themed *):not(.checkout-order-summary *):not(.booking-confirmation-module *)";
