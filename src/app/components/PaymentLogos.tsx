...
import ClearpaySvg from "@/app/assets/clearpaysvg.png";
import KlarnaSvg from "@/app/assets/klarnasvg.png";
...
const PaymentLogos: React.FC<PaymentLogosProps> = ({
  ...
  const paymentMethods: PaymentMethod[] = [
    {
      name: "Visa",
      icon: SiVisa,
      className: "h-6 w-10 text-blue-600",
    },
    {
      name: "Mastercard",
      icon: null,
    ...
    },
    {
      ...
      className: "h-6 w-10 text-blue-500",
    },
    {
      name: "PayPal",
      icon: SiPaypal,
  ...
  return (
    <div
      className={`mt-4 ${showBorder ? "pt-4 border-t border-gray-200" : ""}`}
    >
      <p className={`text-sm ${headingColor} mb-3 text-center`}>
          ...
          return (
            ...
            >
              {method.isText ? (
                ...
                method.customSvg
              ) : method.isCustomImage ? (
                method.customImage
              ) : (
                method.icon && <method.icon className={method.className} />
              )}
            </div>
          );
        })}
