...
const banners: Banner[] = [
  ...
  // You can add more banners here if needed, using your other banner images
  {
    ...
    content: {
      ...
      paragraph:
        "POWER MEETS PORTABILITY! GET THE APPLE IPAD 9TH GEN AT AN UNBEATABLE PRICE ONLY AT Store! 💥 WORK, STUDY, OR PLAY – THIS SLEEK, HIGH-PERFORMANCE TABLET IS BUILT FOR IT ALL. DON'T MISS OUT!",
      buynow: "#",
    },
